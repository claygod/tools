...
func TestNewRevolverChannel8(t *testing.T) {
	rCh := NewRevolverChannel8Bit[int](3)
...
func TestRevolverChannel8OrderOfResults(t *testing.T) {
	rCh := NewRevolverChannel8Bit[int](3)
...
func TestRevolverChannel8Len1(t *testing.T) {
	rCh := NewRevolverChannel8Bit[int](3)
...
func TestRevolverChannel8StopClose(t *testing.T) {
	rCh := NewRevolverChannel8Bit[int](3)
...
// ============================================================================
func TestRevolverChannel8_Utilization(t *testing.T) {
...
// ============================================================================
func TestRevolverChannel8_Utilization_Wraparound(t *testing.T) {
	if testing.Short() {
	...
	totalIterations := limit8bit + 1000 // Больше, чем максимум каналов
...
// ============================================================================
func cleanupChannel8[T any](rCh *RevolverChannel8Bit[T]) {
	rCh.Stop()
